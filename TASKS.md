...
1. 🟡 **COMMIT.** The 5.4 work is committed (`faa0b8c`). Still uncommitted as of 2026-08-23b: `scripts/promote_packs.py` (extended — see 5.6), the **12 new library files**, and `knowledge/backups/` in the parent repo. ⛔ `output/` is gitignored, so `output/_review-5.4/` was never durable — **it is now**, mirrored into `knowledge/backups/course-to-markdown/`.
